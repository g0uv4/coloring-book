...
[references/prompt-templates.md](references/prompt-templates.md) + confirmed keep list.
`imagine_image_to_image` on `USER_PHOTO` only. Aspect 2:3 or 3:2. No third-party style images.
Save as `plate-raw.png`.
